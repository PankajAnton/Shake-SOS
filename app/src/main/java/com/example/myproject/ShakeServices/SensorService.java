package com.example.myproject.ShakeServices;
...
import com.example.myproject.ShakeMainActivity;
import com.example.myproject.R;
import com.example.myproject.ShakeDetector;
    ...
    public void onCreate() {
        ...
        mShakeDetector.setOnShakeListener(new ShakeDetector.OnShakeListener() {
            ...
            public void onShake(int count) {
                ...
                if (count == 3) {
                    Toast.makeText(SensorService.this, "Starting Service...", Toast.LENGTH_SHORT).show();
                    // vibrate the phone
                    vibrate();

                    Intent intent =new Intent(SensorService.this, ShakeMainActivity.class);
...
//                            startActivity(callIntent);
    ...
    public void vibrate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            vibrator.cancel();
            long[] patternVBRT={0,200,10,500,15,1000,0,200,10,500,15,1000,0,200,10,500,15,1000,0,200,10,500,15,1000};
            vibrator.vibrate(patternVBRT,-1);//vibEFF
        } else {
