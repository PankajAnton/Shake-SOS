...
import com.example.myproject.ShakeServices.ReactivateService;
import com.example.myproject.ShakeServices.SensorService;
...
//        listView.setAdapter(customAdapter);
        ...
        view_contacts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ShakeMainActivity.this, SavedContacts.class);
        ...
        add_contacts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (db.count() != 10) {
                    ...
                    Toast.makeText(ShakeMainActivity.this, "Can't Add more than 10 Contacts", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        maps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ShakeMainActivity.this, MapsActivity.class);
                startActivity(intent);
            }
        });
        ...
        dial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ShakeMainActivity.this, CallActivity.class);
                startActivity(intent);
            }
        });
...
//                ImageView image = (ImageView) findViewById(R.drawable.power_on);
                ...
                if (ActivityCompat.checkSelfPermission(ShakeMainActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ShakeMainActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                fusedLocationClient.getCurrentLocation(LocationRequest.QUALITY_BALANCED_POWER_ACCURACY, new CancellationToken() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            ...
                            DbHelper db = new DbHelper(ShakeMainActivity.this);
